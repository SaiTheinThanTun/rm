...
ui <- fluidPage(
  tabsetPanel(
    ...
    tabPanel(title = strong("Typology Parameters"),
             column(3,
                    numericInput(inputId="R0", label = "basic reproduction number", value = 2.85, min=NA, max=NA),
             ...
             column(3,
                    ...
                    sliderInput(inputId="muC", label = "imported clinical cases per 1000 population per year ", value = 0, min=0, max=10),
                    sliderInput(inputId="muA", label = "imported super-microscopic asymtomatic infection per 1000 population per year ", value = 1, min=0, max=100),
                    sliderInput(inputId="muU", label = "imported sub-microscopic asymtomatic infections per 1000 population per year ", value = 1, min=0, max=100)
             ),
             column(3,
