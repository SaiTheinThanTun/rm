...
//  double fail = ((Y+startyear)<2019)*(percfail2018/100)+((Y+startyear)>=2019)*((Y+startyear)<2020)*(percfail2019/100)+((Y+startyear)>=2020)*(percfail2020/100);
  ...
  double fail = ((Y+startyear)<2018)*(percfail2018/100)
    +((Y+startyear)>=2018)*((Y+startyear)<2019)*(((percfail2019-percfail2018)/100)*(Y+startyear-2019)+(percfail2018/100))
    +((Y+startyear)>=2019)*((Y+startyear)<2020)*(((percfail2020-percfail2019)/100)*(Y+startyear-2020)+(percfail2019/100))
    +((Y+startyear)>=2020)*(percfail2020/100)
    ;
