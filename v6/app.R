  ...
  tabsetPanel(
    ...
    tabPanel(title = strong("Typology Parameters"),
             ...
             column(3,
                    ...
                    sliderInput(inputId="muU", label = "imported asymptomatic microscopically undetectable carriers per 1000 population per year ", value = 10, min=0, max=100)
             ),
             column(3,
  ...
  output$MODEL <- renderPlot({
    ...
    runGMS<-function(scenario) 
    {
      ...
      parameters <- c(
        ...
        # RCDsensA = 60,               # Sensitivity of RCD test used for asymptomatic microscopically detectable carriers [0 to 100]
        # RCDsensU = 0,                # Sensitivity of RCD test used for asymptomatic microscopically undetectable carriers [0 to 100]
        ...
        # muA = 50,                    # number of imported asymptomatic microscopically detectable carriers per 1000 population per year [0 to 100]
        # muU = 50,                    # number of imported asymptomatic microscopically undetectable carriers per 1000 population per year [0 to 100]
