...
List modGMS(double t, NumericVector state, NumericVector parameters) 
{
  // switches
  ...
  int RCDs=parameters["RCDs"] ;
  
  //state
  int Y = state["Y"];
  int Cinc_det = state["Cinc_det"];
  int Cinc_tot = state["Cinc_tot"];
  int S_0 = state["S_0"];
  int IC_0 = state["IC_0"];
  int IA_0 = state["IA_0"];
  int IU_0 = state["IU_0"];
