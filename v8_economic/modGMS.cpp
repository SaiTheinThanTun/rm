...
List modGMS(double t, List state, List parameters) 
{
         // convert %s to proportions
  int covEDATi=0.9*["covEDATi"]/100;
  int covEDAT0=0.9*["covEDAT0"]/100;
  int covITNi=["covITNi"]/100;
  int covITN0=["covITN0"]/100;
  int effITN = ["effITN"]/100;
  int covIRSi=["covIRSi"]/100;
  int covIRS0=["covIRS0"]/100;
  int effIRS = ["effIRS"]/100;
  int covRCDi=["covRCDi"]/100;
  int covRCD0=["covRCD0"]/100;
  int RCDs=["RCDs"]/100;
  int RCDsensC=["RCDsensC"]/100;
  int RCDsensA=["RCDsensA"]/100;
  int RCDsensU=["RCDsensU"]/100;
  int covMSATi=["covMSATi"]/100;
  int covMSAT0=["covMSAT0"]/100;
  int MSATsensC=["MSATsensC"]/100;
  int MSATsensA=["MSATsensA"]/100;
  int MSATsensU=["MSATsensU"]/100;
         
         int clustRCDrad=["clustRCDrad"]/100;
         int clustRCDcoex=["clustRCDcoex"]/100;
         int cm_1=cm_1/100;
         int cm_2=cm_2/100;
         int cm_3=cm_3/100;
         int cmda_1=cmda_1/100;
         int cmda_2=cmda_2/100;
         int cmda_3=cmda_3/100;
         int effv_1=effv_1/100;
         int effv_2=effv_2/100;
         int effv_3=effv_3/100;
         int rhoa=rhoa/100;
         int rhou=rhou/100;
         int ps=ps/100;
         int pr=pr/100;
         ...
         // convert time scales
         int dm=dm/12;
         int tm_1 = 2018+(tm_1/12);
         int tm_2 = 2018+(tm_2/12);
         int tm_3 = 2018+(tm_3/12);
